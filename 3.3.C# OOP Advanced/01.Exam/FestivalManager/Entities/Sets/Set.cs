namespace FestivalManager.Entities.Sets
{
	...
	public abstract class Set : ISet
	{
        ...
        //public TimeSpan ActualDuration => songs.Aggregate(TimeSpan.Zero, (subtotal, t) => subtotal.Add(t.Duration));
		...
		public void AddSong(ISong song)
		{
            ...
            //var potentialTotalDuration = ActualDuration.Add(song.Duration);
            //if (MaxDuration.CompareTo(potentialTotalDuration) == -1)
